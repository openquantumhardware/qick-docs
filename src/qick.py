...
try:
    ...
    pass
import numpy as np
from parserdemo import parse_to_bin
from streamerdemo import DataStreamer
from qick_asmdemo import QickConfig, QickProgram
from helpersdemo import trace_net, get_fclk, BusParser
